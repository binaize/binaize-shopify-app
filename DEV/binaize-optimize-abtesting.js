...
var experiment_id = 'f4c5a35d6a1f4c7dbf6ff5d34addae86';

var variation_1 = 'c38b75c54382417d834f9e5eaf809007';
var variation_2 = '1600cf81176e42b6a752dedb5f3a6e64';
var variation_original = '0915715ac84b4b11bbe9ae08b9212753';
            ...
            if (res.status === 200) {
                res.json().then(data => {
                    ...
                    if ("variation_id" in data) {
                        ...
                        } else if (var_id === variation_2) {
                            console.log("Redirecting to : " + var_id);
                            document.getElementById("edited_title_2").style.display = "block";
                        } else {
                            console.log("Redirecting to : " + var_id);
